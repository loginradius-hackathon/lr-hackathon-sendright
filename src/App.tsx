  ...
  useEffect(() => {
    ...
    axios.get(`${baseURL}/api/v1/metadata`).then((response: any) => {
      ...
      setTemplateText((t) => ({
        ...
        templateType: response.data.email_types[0],
        language: response.data.languages.find((language) => {
  ...
  return (
    ...
    <div className="flex flex-col h-screen ">
      ...
      <div className="main-container flex w-full md:h-screen h-auto flex-col md:flex-row">
        <div
          className=" flex md:w-3/12 w-full overflow-y-auto md:border-r md:border-solid md:border-gray-300 bg-white md:max-h-[91vh] h-auto p-6">
          <div className="d-flex flex-col w-full">
            <div>
              <h2 className="font-medium text-gray-700 mb-1 text-lg">AI-Powered Email Generator</h2>
              <p className="text-gray-600 mb-6 text-sm">Your Answer to Stress-Free and Professional Email Writing!</p>
            </div>
            <div className="form-group flex flex-col gap-1 mb-4">
              ...
              <input type="text" id="name"
                className="py-2 px-4 rounded-md border border-solid border-gray-400 text-sm"
                name="senderName" placeholder="Sender name" data-form-type="name"
            ...
            <div className="form-group flex flex-col gap-1 mb-4">
              ...
              <input type="text" id="rname"
                className="py-2 px-4 rounded-md border border-solid border-gray-400 text-sm"
                name="recipientName" placeholder="Recipient name" data-form-type="name"
                value={templateText.recipientName}
                onChange={(e) => {
                  setTemplateText({
                    ...templateText,
                    [e.target.name]: e.target.value,
            ...
            <div className="form-group flex flex-col gap-1 mb-4">
              ...
              <select
                className="py-2 pl-[11px] pr-4 rounded-md border border-solid border-gray-400 text-sm"
                name="industry" placeholder="Industry" data-form-type="other" onChange={(e) => {
            ...
            <div className="form-group flex flex-col gap-1 mb-4">
              ...
              <select
                className="py-2 pl-[11px] pr-4 rounded-md border border-solid border-gray-400 text-sm"
                name="templateType" placeholder="Email Type" data-form-type="other" onChange={(e) => {
            ...
            <div className="form-group flex flex-col gap-1 mb-4">
              ...
              <input type="text" id="rname"
                className="py-2 px-4 rounded-md border border-solid border-gray-400 text-sm"
                name="prompt" placeholder="Additional Information" data-form-type="name"
                value={templateText.prompt}
                onChange={(e) => {
                  setTemplateText({
                    ...templateText,
                    [e.target.name]: e.target.value,
            ...
            <div className="form-group flex flex-col gap-1 mb-4">
              ...
              <select id="rname"
                className="py-2 px-4 rounded-md border border-solid border-gray-400 text-sm"
                name="sentiment" placeholder="DeliveryTone" data-form-type="name"
                onChange={(e) => {
                  setTemplateText({
                    ...templateText,
                    [e.target.name]: e.target.value,
                ...
                value={deliveryToneOptions.find((deliveryTone) => {
                  return deliveryTone === templateText.sentiment
                })}
                defaultValue={deliveryToneOptions.find((deliveryTone) => {
                  return deliveryTone === "Formal"
                })}>
            ...
            <div className="form-group flex flex-col gap-1 mb-4">
              ...
              <select
                className="py-2 pl-[11px] pr-4 rounded-md border border-solid border-gray-400 text-sm"
                name="language" placeholder="Language" data-form-type="other" onChange={(e) => {

                  setTemplateText({ ...templateText, [e.target.name]: e.target.value });
                }}
                value={languageOptions.find((language) => {
                  return language === templateText.language
                })}
                defaultValue={languageOptions.find((language) => {
                  return language === "English"
                })}
              >
            ...
            <div className="form-group flex flex-col gap-1 mb-4 ">
              ...
              <input type="text" id="name"
                className="py-2 px-4 rounded-md border border-solid border-gray-400 text-sm"
                name="brandLogoURL" placeholder="Brand Logo URL" data-form-type="name"
                value={templateText.brandLogoURL}
                onChange={(e) => {
                  setTemplateText({
                    ...templateText,
                    [e.target.name]: e.target.value,
            ...
            <div className="d-flex items-end w-full pb-8">
              <button
                className="bg-blue-700 py-1 px-4 text-white rounded-md h-10 flex items-center gap-2 font-normal transition hover:bg-blue-600 ml-auto"
                onClick={fetchEmailContent}>Generate
              </button>
            </div>
          </div>
        </div>
        <div className="md:w-9/12 w-full bg-gray-50">
          <div
            className="md:mt-0 mt-6 h-14 bg-white px-5 flex justify-between text-base text-gray-700 items-center font-medium border-b border-solid border-gray-300">
            <div>&nbsp;</div>
            <div className="grow">&nbsp;</div>
            <div className="form-group  ">
              <select
                className="py-2 pl-[11px] pr-4 rounded-md border border-solid border-gray-400 text-sm"
                placeholder="Network" data-form-type="other" onChange={(e) => {

                  setSelectedTemplate(e.target.value)

                }} value={templateOptions.find((template) => {
                  return template === selectedTemplate
                })}
                defaultValue={templateOptions.find((template) => {
